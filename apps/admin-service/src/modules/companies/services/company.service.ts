...
export class CompanyService {
  ...
  async completeInitialSetup(id: string, companyData: UpdateCompanyDto): Promise<Company> {
    const company = await this.findById(id);
    ...
    company.metadata.setupCompleted = true;
    company.metadata.setupCompletedAt = new Date().toISOString();
