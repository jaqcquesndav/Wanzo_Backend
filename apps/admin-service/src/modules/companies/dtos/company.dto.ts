import { IsString, IsEmail, IsArray, IsObject, ValidateNested, IsOptional, IsBoolean, IsUUID } from 'class-validator';
...
export class CreateCompanyDto {
  ...
  @ApiPropertyOptional({ description: 'External ID from auth service' })
  @IsOptional()
  @IsString()
  externalId?: string;
}
...
export class CompleteCompanyProfileDto extends UpdateCompanyDto {
  @ApiProperty({ description: 'External company ID from auth service' })
  @IsUUID()
  externalId!: string;
}