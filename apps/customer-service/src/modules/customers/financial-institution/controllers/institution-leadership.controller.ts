...
export class InstitutionLeadershipController {
  ...
  async appointLeader(
    ...
    try {
      ...
      return await this.institutionLeadershipService.addLeader(institutionId, createLeadershipDto as any);
    } catch (error) {
  ...
  async getInstitutionLeadership(
    ...
    try {
      ...
      const result = await this.institutionLeadershipService.getLeaders(institutionId);
      return result.leaders as any;
    } catch (error) {
  ...
  async getLeadershipById(
    ...
    try {
      return await this.institutionLeadershipService.getLeaderById(leadershipId) as any;
    } catch (error) {
  ...
  async updateLeadership(
    ...
    try {
      ...
      return await this.institutionLeadershipService.updateLeader(leadershipId, updateLeadershipDto as any);
    } catch (error) {
  ...
  async revokeLeadership(
    ...
    try {
      return await this.institutionLeadershipService.deleteLeader(leadershipId) as any;
    } catch (error) {
      const status = (error as Error).message.includes('non trouvé') ? HttpStatus.NOT_FOUND : HttpStatus.BAD_REQUEST;
      throw new HttpException((error as Error).message, status);
    }
